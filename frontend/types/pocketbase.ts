...
export type PolarProductsRecord<Tfeatures = unknown> = {
  created: IsoAutoDateString
  description?: string
...
export type UsersRecord = {
  ...
  name?: string
  password: string
  polar_customer_created?: IsoDateString
  polar_customer_deleted?: IsoDateString
  polar_customer_id?: string
  polar_customer_modified?: IsoDateString
  subscription_cancel_at_period_end?: IsoDateString
  subscription_current_period_end?: IsoDateString
...
export type PolarProductsResponse<
  Tfeatures = unknown,
  Texpand = unknown
> = Required<PolarProductsRecord<Tfeatures>> & BaseSystemFields<Texpand>
export type UsersResponse<Texpand = unknown> = Required<UsersRecord> &
  AuthSystemFields<Texpand>
export type WorkspacesResponse<Texpand = unknown> = Required<WorkspacesRecord> &
  BaseSystemFields<Texpand>
...
export type CollectionRecords = {
  ...
  notes: NotesRecord
  polar_products: PolarProductsRecord
  users: UsersRecord
...
export type CollectionResponses = {
  ...
  notes: NotesResponse
  polar_products: PolarProductsResponse
  users: UsersResponse
